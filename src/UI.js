const ui = (() =>{
  ...
  const navAddProject = (name, id) => {
    ...
    projectElement.setAttribute("id", "testing123");
    projectElement.innerHTML = `
      <div class="nav-projects-test" id="${id}">${name}</div>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="nav-projects-test" id="nav-projects-icon">
